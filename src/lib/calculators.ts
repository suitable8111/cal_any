...
export const calculators: CalculatorMeta[] = [
  ...
  },
  {
    slug: "/brokerage-fee",
    title: "부동산 중개수수료 계산기",
    description: "매매·전세·월세 거래금액별 중개보수(복비) 상한 요율 자동 계산",
    keywords: [
      "중개수수료",
      "복비",
      "중개보수",
    ...
    seo: "매매·교환·전세·월세 거래 유형과 거래금액을 입력하면 2021년 개정 요율 기준 부동산 중개보수(복비) 상한액을 계산합니다. 월세는 환산보증금(보증금+월세×100)을 자동 적용하고 요율표를 함께 제공합니다.",
    category: "financial",
  },
  {
    slug: "/rent-conversion",
    title: "전월세 전환 계산기",
    description: "전세 보증금 ↔ 월세를 전환율 기준으로 상호 변환",
    keywords: [
      "전월세전환",
      "전월세전환율",
      "전세월세변환",
    ...
    seo: "전세 보증금을 월세로, 월세를 전세 보증금으로 전월세 전환율을 적용해 변환합니다. 주택임대차보호법상 법정 전환율(기준금리+2%p) 안내와 전환율별 비교표를 제공합니다.",
    category: "financial",
  },
  {
    slug: "/housing-subscription",
    title: "청약 가점 계산기",
    description: "무주택기간·부양가족·통장 가입기간으로 청약 가점(84점 만점) 계산",
    keywords: [
      "청약가점",
      "청약점수",
      "주택청약",
    ...
    emoji: "🎯",
    accent: "from-green-500/15 to-lime-500/10",
    seo: "무주택기간(최대 32점), 부양가족 수(최대 35점), 청약통장 가입기간(최대 17점)을 입력하면 주택청약 가점제 총점(84점 만점)을 계산하고 항목별 점수표를 제공합니다.",
    category: "financial",
  },
  {
    slug: "/salary",
  ...
  },
  {
    slug: "/fuel-cost",
    title: "유류비 계산기",
    description: "주행거리·연비·유가로 예상 주유비와 km당 비용, 왕복 경비 계산",
    keywords: [
      "유류비",
      "주유비",
      "기름값",
    ...
    seo: "주행거리, 차량 연비(km/L), 유가(원/L)를 입력하면 편도·왕복 유류비와 km당 주행 비용을 계산합니다. 통행료를 더한 총 경비와 월간 주행 비용 추정까지 지원합니다.",
    category: "lifestyle",
  },
  {
    slug: "/car-tax",
    title: "자동차세 계산기",
    description: "배기량·차령별 자동차세와 연납 할인액 계산 (전기차 포함)",
    keywords: [
      "자동차세",
      "자동차세계산",
      "연납할인",
    ...
    seo: "차량 배기량(cc)과 차령(연식)을 입력하면 비영업용 승용차 기준 자동차세와 지방교육세, 차령 경감(3년차부터 5%씩 최대 50%), 1월 연납 시 할인액까지 계산합니다. 전기차 정액 세액도 지원합니다.",
    category: "lifestyle",
  },
  {
    slug: "/customs-duty",
    title: "해외직구 관세 계산기",
    description: "물품가격·배송비로 면세 한도 판정과 관세·부가세를 계산",
    keywords: [
      "해외직구",
      "관세",
      "관세계산",
    ...
    seo: "해외직구 물품가격과 배송비, 발송 국가(미국 200달러/기타 150달러 면세)를 입력하면 면세 여부를 판정하고, 과세 시 품목별 관세율과 부가가치세 10%를 반영한 예상 세금을 계산합니다.",
    category: "lifestyle",
  },
  {
  ...
  },
  {
    slug: "/due-date",
    title: "출산예정일 계산기",
    description: "마지막 생리 시작일로 출산예정일과 현재 임신 주수를 계산",
    keywords: [
      "출산예정일",
      "출산예정일계산",
      "임신주수",
    ...
    emoji: "🤰",
    accent: "from-pink-500/15 to-rose-500/10",
    seo: "마지막 생리 시작일과 생리 주기를 입력하면 네겔레 법칙(+280일) 기준 출산예정일, 오늘 기준 임신 주수·개월수, 삼분기 구분과 시기별 주요 검사 일정을 계산합니다.",
    category: "health",
  },
  {
    slug: "/ovulation",
    title: "배란일 계산기",
    description: "마지막 생리일과 주기로 배란일·가임기·다음 생리 예정일 계산",
    keywords: [
      "배란일",
      "배란일계산",
      "가임기",
    ...
    seo: "마지막 생리 시작일과 평균 생리 주기를 입력하면 예상 배란일과 임신 가능성이 높은 가임기(배란일 5일 전~1일 후), 다음 생리 예정일을 3주기까지 계산합니다.",
    category: "health",
  },
  {
    slug: "/body-fat",
    title: "체지방률 계산기",
    description: "줄자로 잰 둘레(목·허리·엉덩이)로 체지방률과 체지방량 추정",
    keywords: [
      "체지방률",
      "체지방계산",
      "체지방량",
    ...
    seo: "키, 목·허리·엉덩이 둘레를 입력하면 미 해군(US Navy) 공식으로 체지방률을 추정하고, 몸무게를 입력하면 체지방량·제지방량과 성별 체지방률 기준표를 함께 제공합니다.",
    category: "health",
  },
  {
    slug: "/one-rep-max",
  ...
  },
  {
    slug: "/char-counter",
    title: "글자수 세기",
    description: "자소서·리포트 글자수를 공백 포함/제외, 바이트 기준으로 계산",
    keywords: [
      "글자수세기",
      "글자수",
      "자소서 글자수",
    ...
    seo: "텍스트를 입력하면 공백 포함·제외 글자수, 바이트 수(한글 2바이트/UTF-8 3바이트 기준), 단어 수, 줄 수, 원고지 매수를 실시간으로 계산합니다. 자기소개서, 리포트, SNS 글자수 제한 확인에 유용합니다.",
    category: "dev",
  },
  {
    slug: "/base-converter",
